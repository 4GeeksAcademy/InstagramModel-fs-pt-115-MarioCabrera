...
Revision ID: 8cbf88dedaf2
Revises: a5cffa318ac2
Create Date: 2025-08-11 11:41:24.581970
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('firstname', sa.String(length=45), nullable=False))
        batch_op.add_column(sa.Column('lastname', sa.String(length=45), nullable=False))
